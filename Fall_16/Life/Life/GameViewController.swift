...
*/
    ...
    override func viewDidLayoutSubviews() {
		...
		//let scene = SceneChildhood();		currentLevel = 2
		//let scene = SceneAdolescence();	currentLevel = 3
		//let scene = SceneTeens();			currentLevel = 4
		//let scene = SceneCollege();		currentLevel = 5
		//let scene = SceneAdulthood();		currentLevel = 6
		//let scene = SceneEnd();			currentLevel = 7
